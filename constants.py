...
point_spawn_1 = (WIDTH_WINDOW/2, HEIGHT_WINDOW - 50 - 2*PLATFORM_HEIGHT)
point_spawn_2 = ((len(level_2[0]) * PLATFORM_WIDTH)//2, PLATFORM_HEIGHT*3)
LIST_LEVEL = [level_1, level_2]
LIST_SPAWN = [point_spawn_1, point_spawn_2]
...
level_digit_1, num_blok_x_1, num_blok_y_1  = get_map_platform(level_1)
level_digit_2, num_blok_x_2, num_blok_y_2  = get_map_platform(level_2)
########################################################################################################################
"""Изображения"""
